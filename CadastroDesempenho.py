...
class combobox:
    ...
    def insert(self,idativadade, idmatricula, conclusao, desempenho):
        ...
        try:
            ...
            cursor.execute(sql,[idativadade, idmatricula, conclusao, desempenho])
    ...
    def situacao(self):
        ...
        try:    
            ...
            sql = "SELECT SELECT Situacao.IdSituacao,Atividade.nomeAtividade,Aluno.nome,Situacao.conclusao,Situacao.desempenho FROM Situacao INNER JOIN Atividade,Aluno ON Id_Atividade = IdAtividade AND Id_matricula = matricula"
